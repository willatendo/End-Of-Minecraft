...
public class PlanetAlphaSkyRenderer {
	...
	public static void renderSky(WorldRenderContext worldRenderContext) {
		renderSky(worldRenderContext.worldRenderer(), worldRenderContext.matrixStack(), worldRenderContext.projectionMatrix(), worldRenderContext.tickDelta(), worldRenderContext.camera());
	}
