...
import willatendo.endofminecraft.server.entity.EndOfMinecraftDamageSources;
...
public class IrradiatedEffect extends MobEffect {
	...
	public void applyEffectTick(LivingEntity livingEntity, int amplification) {
		livingEntity.hurt(livingEntity.damageSources().source(EndOfMinecraftDamageSources.IRRADIATION), 2.0F);
	}
