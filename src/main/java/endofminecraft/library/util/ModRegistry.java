...
{	
	...
	public static final EndWorldType endWorldType = new EndWorldType();
	...
	public static void registry()
	{
		...
		endWorldType.setRegistryName(ModUtils.rL("end_world_type"));
		ForgeRegistries.WORLD_TYPES.register(endWorldType);
